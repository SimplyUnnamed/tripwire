...
const ChainMapRendererOrgchartTop=function(n){ChainMapRendererBase.apply(this,arguments);const i={x:55,y:45};function o(n,o){return{x:n*i.x*options.chain.nodeSpacing.x,y:((0==o?-.3:0)+o)*i.y*options.chain.nodeSpacing.y}}this.initialRads=function(n){return.5*n},this.centringOptions={x:!0},this.setPosition=function(n,i,t){n.position=o(t,i),n.rad_centre=t},this.drawConnection=function(n,i){const o=i.parent.position.y,t=(i.position.y,{x:i.position.x,y:o}),e={x:i.position.x,y:o};n.bezierCurveTo(e.x,e.y,t.x,t.y,i.parent.position.x,o)},this.drawGridlines=function(n,i,t){n.beginPath();const e=o(t.min,i),r=o(t.max,i);n.moveTo(e.x,e.y),n.lineTo(r.x,r.y),n.strokeStyle=propertyFromCssClass("grid-default","color"),n.stroke(),n.fillStyle=propertyFromCssClass("grid-default","color"),n.font="10px Sans-serif",n.fillText(i,e.x,e.y+12)}};ChainMapRendererOrgchartTop.prototype=new ChainMapRendererBase;
