...
var systemAnalysis=new function(){const e=[];this.addMutator=function(s){e.push(s)},this.analyse=function(s,t){t||(t=appData.systems[s]),t||(t=function(e){const s="string"==typeof e&&e.indexOf("|")>=0?appData.genericSystemTypes[e.substring(0,e.indexOf("|"))]:appData.genericSystemTypes.indexOf(e)>=0?e:appData.genericSystemTypes[e];let t=void 0;s&&"Class-"==s.substring(0,6)?t=1*s.substring(6):s&&"C"==s.substring(0,1)&&(t=1*s.substring(1));const a="High-Sec"==s?.8:"Low-Sec"==s?.4:"Null-Sec"==s?-.1:void 0,c="Triglavian"==s?500026:void 0;return{security:a,class:t,factionID:c}}(s)),s||(s=t.systemID);const a=Object.assign({},t);return a.baseSecurity=1*t.security,a.pathSymbol="■",a.systemTypeModifiers=[],e.forEach(function(e){e.mutate(a,s)}),a.systemTypeClass=a.class?"wh class-"+a.class:500026==a.factionID?"triglavian":a.security>=.45?"hisec":a.security>0?"lowsec":a.security<=0?"nullsec":"unknown",a.systemTypeName=a.class?"C"+a.class:500026==a.factionID?"Trig":a.baseSecurity>=.45?"HS":a.baseSecurity>0?"LS":a.baseSecurity<=0?"NS":" ",a.genericSystemType=a.class?"Class-"+a.class:500026==a.factionID?"Triglavian":a.baseSecurity>=.45?"High-Sec":a.baseSecurity>0?"Low-Sec":a.baseSecurity<=0?"Null-Sec":" ",a.effectClass="Black Hole"===a.effect?"blackhole":"Cataclysmic Variable"===a.effect?"cataclysmic-variable":"Magnetar"===a.effect?"magnetar":"Pulsar"===a.effect?"pulsar":"Red Giant"===a.effect?"red-giant":"Wolf-Rayet Star"===a.effect?"wolf-rayet":void 0,a}};
...
var guidance=function(e){var r=function(e){var r=[];for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&r.push(n);return r},n=function(e,r){return parseFloat(e)-parseFloat(r)};function t(e,r){if(!(r=systemAnalysis.analyse(3e7+1*r)))return e;switch(options.chain.routeIgnore.enabled&&options.chain.routeIgnore.systems.indexOf(r.name)>=0&&(e+=100),options.chain.routeSecurity){case"highsec":return e+(r.security<.45?100:0);case"avoid-high":return e+(r.security>=.45?100:0);case"avoid-null":return e+(r.security<=0?100:0);default:return e}}var a=function(e,a,o,i){i=i||1/0;var c,u={},s={0:[a]},h={},f=function(e,r){var n=""+e;s[n]||(s[n]=[]),s[n].push(r)};for(u[a]=0;s&&!u[o]&&(c=r(s)).length;){c.sort(n);var l=c[0],p=s[l],v=p.shift(),y=parseFloat(l),d=e[v]||{};for(var g in p.length||delete s[l],d)if(Object.prototype.hasOwnProperty.call(d,g)){var S=t(d[g],g)+y,C=u[g];(void 0===C||C>S)&&(u[g]=S,f(S,g),h[g]=v)}}return void 0===u[o]?null:h},o=function(e,r){for(var n=[],t=r;t;)n.push(t),predecessor=e[t],t=e[t];return n.reverse(),n},i={kSpaceCache:{},clearCache:function(){i.kSpaceCache={}}};return i.findShortestPath=function(e,r,n){const t=[r,n],c=t.join(","),u=i.kSpaceCache[c];return void 0===u?i.kSpaceCache[c]=function(e,r){for(var n,t,i,c=r.shift(),u=[];r.length;){if(n=r.shift(),!(t=a(e,c,n)))return null;if(i=o(t,n),!r.length)return u.concat(i);u.push.apply(u,i.slice(0,-1)),c=n}}(e,t):u},i}();
...
var chain=new function(){var e=this;this.map,this.view,this.drawing,this.data={},thirdPartySuppliers=[thera];const i={orgChart:new ChainMapRendererOrgchart(this),radial:new ChainMapRendererRadial(this)};this.renderer=i[options.chain.renderer],this.renderer.switchTo(),this.useRenderer=function(e){if(!i[e])throw"Unknown renderer "+e;this.renderer!=i[e]&&(this.renderer.switchFrom(),this.renderer=i[e],this.renderer.switchTo(),this.redraw())},this.activity=function(e){for(var i=0,s=(t=document.querySelectorAll("#chainMap .nodeActivity span")).length;i<s;++i)t[i].className=t[i].className+" invisible";var t;for(i=0,s=(t=document.querySelectorAll("#chainMap [data-nodeid]")).length;i<s;++i){var a=t[i].getAttribute("data-nodeid");if(e[a]){var n=e[a].shipJumps,r=e[a].podKills,c=e[a].shipKills,l=e[a].npcKills,o=t[i].getElementsByClassName("nodeActivity")[0];if(n>0){var d=o.getElementsByClassName("jumps")[0];d.className=d.className.replace(/invisible/g,""),d.setAttribute("data-tooltip",n+" Jumps")}if(r>0){var h=o.getElementsByClassName("pods")[0];h.className=h.className.replace(/invisible/g,""),h.setAttribute("data-tooltip",r+" Pod Kills")}if(c>0){var p=o.getElementsByClassName("ships")[0];p.className=p.className.replace(/invisible/g,""),p.setAttribute("data-tooltip",c+" Ship Kills")}if(l>0){var m=o.getElementsByClassName("npcs")[0];m.className=m.className.replace(/invisible/g,""),m.setAttribute("data-tooltip",l+" NPC Kills")}}}return SystemActivityToolTips.attachedElements&&SystemActivityToolTips.attachedElements.length>0&&SystemActivityToolTips.detach($("#chainMap .whEffect")),SystemActivityToolTips.attach($("#chainMap .nodeActivity > span[data-tooltip]:not(.invisible)")),e},this.occupied=function(e){for(var i in $("#chainMap [data-icon='user'], #chainMap [data-icon='user'] + .badge").addClass("invisible"),e)$("#chainMap [data-nodeid='"+e[i].systemID+"'] [data-icon='user']").removeClass("invisible"),$("#chainMap [data-nodeid='"+e[i].systemID+"'] [data-icon='user'] + .badge").removeClass("invisible").html(e[i].count);return OccupiedToolTips.attach($("#chainMap [data-icon='user']:not(.invisible)")),e},this.flares=function(e){if($("#chainMap div.node").removeClass("redNode yellowNode greenNode"),$("#chainGrid tr").removeClass("red yellow green"),e)for(var i in e.flares){var s=e.flares[i].systemID,t=e.flares[i].flare,a=($("#chainMap [data-nodeid="+s+"]").addClass(t+"Node").parent().index()-1)/3*2;a>0&&$("#chainGrid tr:eq("+a+")").addClass(t).next().addClass(t)}return e},this.grid=function(){if(0==options.chain.gridlines)return $("#chainGrid tr").addClass("hidden"),!1;$("#chainGrid tr").removeClass("hidden");var e=Math.max(0,2*$(".google-visualization-orgchart-table tr:has(.node)").length-1);$("#chainGrid tr:gt("+e+")").addClass("hidden")},this.nodes=function(e){var i={cols:[{label:"System",type:"string"},{label:"Parent",type:"string"}],rows:[]},s=["Q003","E004","L005","Z006","M001","C008","G008","A009","SML"],t=[];function a(e,i){if(!e||!tripwire.systems[e])return!1;const s=options.chain.tabs[options.chain.active];return n(e,i,null,null,s&&0!=s.systemID&&0>s.systemID.indexOf(",")?options.chain.tabs[options.chain.active].name:void 0,"&nbsp;",["top-level"])}function n(e,i,s,t,a,n,r){const c=systemAnalysis.analyse(e);var l="<span class='"+c.systemTypeClass+"'>"+c.systemTypeName+c.systemTypeModifiers.join("")+"</span>";a=_.escape(a);const o="name"==options.chain.sigNameLocation?a||(c.name?c.name:"&nbsp;"):"name_prefix"==options.chain.sigNameLocation&&a?a+(c.name?" - "+c.name:""):c.name?c.name:"&nbsp;";var d={v:i,systemID:e},h="<div id='node"+i+"' data-nodeid='"+e+"'"+(s?" data-sigid='"+s+"'":"")+(t?" data-inSigid='"+t+"'":"")+" class='node "+(r||[]).join(" ")+"'><div class='nodeIcons'><div style='float: left;'>"+systemRendering.renderEffect(c,"i")+"</div><div style='float: right;'><i data-icon='user' class='invisible'></i><span class='badge invisible'></span></div></div><h4 class='nodeClass'>"+l+"</h4><h4 class='nodeSystem'>"+(c.name?"<a href='.?system="+c.name+"'>"+o+"</a>":o)+"</h4><h4 class='nodeType'>"+n+"</h4><div class='statics'>"+function(e){if(!e)return"";const i={"High-Sec":"H","Low-Sec":"L","Null-Sec":"N",Triglavian:"▼","Class-1":"1","Class-2":"2","Class-3":"3","Class-4":"4","Class-5":5,"Class-6":6},s={H:"hisec",L:"lowsec",N:"nullsec","▼":"triglavian"};return e.map(function(e){const t=i[appData.wormholes[e].leadsTo];return'<span class="'+(s[t]||"class-"+t)+'" data-tooltip="'+appData.wormholes[e].leadsTo+" via "+e+'">'+t+"</span>"}).join("")}(c.name?c.statics:[])+"</div><div class='nodeActivity'><span class='jumps invisible'>&#9679;</span>&nbsp;<span class='pods invisible'>&#9679;</span>&nbsp;&nbsp;<span class='ships invisible'>&#9679;</span>&nbsp;<span class='npcs invisible'>&#9679;</span></div></div>";return d.f=h,d}function r(e,i,s){var t=guidance.findShortestPath(tripwire.map.shortest,s-3e7,i.child.systemID-3e7);if(!t)return null;var a={calculated:!0,life:"Gate",parent:{}};return a.parent.id=i.child.id,a.parent.systemID=i.child.systemID,a.parent.name=i.child.name,a.parent.type=i.child.type,a.parent.nth=i.child.nth,a.child={},a.child.id=++e,a.child.systemID=s,a.child.name=tripwire.systems[s].name,a.child.path=t,a.child.jumps=t.length-1,a.child.nth=null,{childID:e,calcNode:a}}function c(e){if(e[0]<=0)return!1;var i=parseInt(e[1]),s=o.length;const t=[],a=function(e){$("#show-viewing").hasClass("active")&&tripwire.systems[e.child.systemID]&&!tripwire.systems[viewingSystemID].class&&!tripwire.systems[e.child.systemID].class&&viewingSystemID!=e.child.systemID&&((t=r(s,e,viewingSystemID))&&(s=t.childID,h.push(t.calcNode),o.push([0,s])));if($("#show-favorite").hasClass("active")&&tripwire.systems[e.child.systemID]&&!tripwire.systems[e.child.systemID].class)for(var i in options.favorites){var t;if(!(tripwire.systems[options.favorites[i]].regionID>=11e6||tripwire.systems[e.child.systemID].regionID>=11e6||options.favorites[i]==e.child.systemID))(t=r(s,e,options.favorites[i]))&&(s=t.childID,h.push(t.calcNode),o.push([0,s]))}};for(var n in d){var c=d[n];if(-1==$.inArray(c.id,p)){var l,m,u,y,v,f,g;if("secondary"==c.parent?(l=tripwire.client.signatures[c.secondaryID],m=tripwire.client.signatures[c.initialID]):(l=tripwire.client.signatures[c.initialID],m=tripwire.client.signatures[c.secondaryID]),u=c.type,"K162",l&&l.systemID==e[0])y=l,v=m,f="K162",g=u;else{if(!m||m.systemID!=e[0])continue;y=m,v=l,g="K162",f=u}var I={};I.id=c.id,I.life=c.life,I.mass=c.mass,I.time=y.modifiedTime,I.parent={},I.parent.id=i,I.parent.systemID=tripwire.systems[y.systemID]?y.systemID:y.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),I.parent.name=v.name,I.parent.type=f,I.parent.typeBM=null,I.parent.classBM=null,I.parent.nth=null,I.parent.signatureID=v.signatureID,I.parent.sigIndex=v.id,I.child={},I.child.id=++s,I.child.systemID=tripwire.systems[v.systemID]?v.systemID:v.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),I.child.name=y.name,I.child.type=g,I.child.typeBM=null,I.child.classBM=null,I.child.nth=null,I.child.signatureID=y.signatureID,I.child.sigIndex=y.id,h.push(I),o.push([I.child.systemID,I.child.id,e[2]]),p.push(I.id),tripwire.systems[v.systemID]&&t.push(1*v.systemID),a(I)}}thirdPartySuppliers.forEach(function(n){const r={parentID:i,nextChildID:++s},c=n.findLinks(1*e[0],r);if(c){s=r.nextChildID-1;for(var l=0;l<c.length;l++){var d=c[l];0>p.indexOf(d.id)&&(0>t.indexOf(d.child.systemID)&&(d.thirdParty=n.nodeNameSuffix,h.push(d),o.push([d.child.systemID,d.child.id,e[2]]),t.push(d.child.systemID),a(d)),p.push(d.id))}}})}if($("#chainTabs .current").length>0){var l=$("#chainTabs .current .name").data("tab").toString().split(","),o=[],d=e,h=[],p=[];if(0==l){let s=0;Object.keys(e).slice().forEach(t=>{const n=tripwire.client.signatures[e[t].initialID],r=tripwire.client.signatures[e[t].secondaryID];n&&tripwire.systems[n.systemID]&&void 0===tripwire.systems[n.systemID].class?(s++,i.rows.push({c:[a(n.systemID,s),{v:null}]}),o.push([n.systemID,s,n.systemID])):r&&tripwire.systems[r.systemID]&&void 0===tripwire.systems[r.systemID].class&&(s++,i.rows.push({c:[a(r.systemID,s),{v:null}]}),o.push([r.systemID,s,r.systemID]))})}else for(var m in l)i.rows.push({c:[a(l[m],parseInt(m)+1),{v:null}]}),o.push([l[m],parseInt(m)+1,l[m]]);for(var u=0;u<o.length;u++)c(o[u])}else{$("#chainError").hide();var y={c:[]},v=viewingSystemID;y.c.push(a(v,1),{v:null}),i.rows.push(y);for(o=[[v,1]],d=e,h=[],p=[],u=0;u<o.length;++u)c(o[u])}const f={};var g=null;for(var m in h){var I=h[m];y={c:[]};const e="id"==options.chain["node-reference"]?I.child.signatureID?I.child.signatureID.substring(0,3):"???":(I.child.type||"(?)")+sigFormat(I.child.typeBM,"type"),a=I.child.path?systemRendering.renderPath(I.child.path):(I.child.sigIndex?"<a href='#' onclick='sigDialog.openSignatureDialog({data: { signature: "+I.child.sigIndex+', mode: "update" }}); return false;\'>':"")+_.escape(I.child.name&&"ref"==options.chain.sigNameLocation?I.child.name:I.child.name&&"ref_prefix"==options.chain.sigNameLocation?I.child.name+" - "+e:e)+(I.child.sigIndex?"</a>":""),r=I.calculated?["calc"]:f[I.child.systemID]?["loop"]:[];I.thirdParty&&r.push("third-party","third-party-"+I.thirdParty);var w=[];"critical"==I.life&&w.push("eol"),"critical"==I.mass?w.push("critical"):"destab"==I.mass&&w.push("destab"),-1==$.inArray(I.parent.type,s)&&-1==$.inArray(I.child.type,s)||w.push("frig");const c=(f[I.parent.systemID]||{chainModifiers:[]}).chainModifiers;y.chainModifiers=w.concat(c),y.chainModifiers.forEach(function(e){w.push(e+"-chain")});const l=n(I.child.systemID,I.child.id,I.id,I.child.sigIndex,I.child.name,a,r.concat(w));var D={v:I.parent.id};y.c.push(l,D),i.rows.push(y),w.length&&t.push(Array(l.v,D.v,w,I.id));const o=(f[I.parent.systemID]||{pathHome:[]}).pathHome;if(y.pathHome=o.concat(I.child),!I.calculated){f[I.child.systemID]=y;const e=guidance.findShortestPath(tripwire.map.shortest,viewingSystemID-3e7,I.child.systemID-3e7);e&&(viewingSystemID==I.child.systemID||e&&(!g||e.length<g.pathLength))&&(g={systemID:I.child.systemID,pathLength:e.length,pathHome:y.pathHome})}}return t.reverse(),{map:i,lines:t,closestToViewing:g}},this.setActiveTab=function(i){$("#chainTabs .tab").removeClass("current"),options.chain.active=i,null!=i&&$("#chainTabs .tab").eq(i).addClass("current"),options.save(),e.redraw(),tripwire.parse(tripwire.client,"refresh")},this.redraw=function(){this.useRenderer(options.chain.renderer);var e=$.extend(!0,{},this.data);e.map=$.extend(!0,{},e.rawMap),this.draw(e)};var s=null;this.draw=function(i){i=void 0!==i?i:{};if(clearTimeout(s),!this.renderer.ready()||Object.keys(i.map||{}).length&&!tripwire.client.signatures)s=setTimeout(function(){e.draw(i)},100);else{if(i.map){this.drawing=!0,this.data.rawMap=$.extend(!0,{},i.map),Object.sort(i.map,"id"),$.extend(i,this.nodes(i.map)),$.extend(this.data,i);const e=options.chain.tabs[options.chain.active]&&options.chain.tabs[options.chain.active].collapsed||[];this.renderer.draw(i.map,i.lines,e),this.grid(),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),WormholeRouteToolTips.attach($("#chainMap .path span[data-tooltip]")),SystemActivityToolTips.attach($("#chainMap .nodeClass span[data-tooltip]")),this.renderInChain(i),this.drawing=!1}!this.data.activity||new Date>this.data.activity.expires?(i.activity={},tripwire.esi.universeJumps().done(function(e,s,t){i.activity.expires=new Date(t.getResponseHeader("expires")),$.each(e,function(s){i.activity[e[s].system_id]={systemID:e[s].system_id,shipJumps:e[s].ship_jumps}})}).then(function(){return tripwire.esi.universeKills().done(function(e){$.each(e,function(s){i.activity[e[s].system_id]?(i.activity[e[s].system_id].podKills=e[s].pod_kills,i.activity[e[s].system_id].shipKills=e[s].ship_kills,i.activity[e[s].system_id].npcKills=e[s].npc_kills):i.activity[e[s].system_id]={systemID:e[s].system_id,podKills:e[s].pod_kills,shipKills:e[s].ship_kills,npcKills:e[s].npc_kills}})})}).then(function(){e.data.activity=e.activity(i.activity)})):i.map&&e.activity(this.data.activity),i.occupied&&(this.data.occupied=this.occupied(i.occupied)),i.flares&&(this.data.flares=this.flares(i.flares))}},this.renderInChain=function(e){if(e.closestToViewing){const i=e.closestToViewing.pathLength<=1,s=i?"In chain: ":e.closestToViewing.pathLength-1+"j from ",t=e.closestToViewing.pathHome.slice().map(function(e){return'<a href=".?system='+tripwire.systems[e.systemID].name+'">'+(e.name||null!=e.signatureID&&e.signatureID.substr(0,3).toUpperCase()||"???")+"</a>"}).join(" &gt; "),a=i?"":"<br/>"+systemRendering.renderPath(guidance.findShortestPath(tripwire.map.shortest,e.closestToViewing.systemID-3e7,viewingSystemID-3e7));$("#inChain").html(s+t+a),$("#inChain").append(this.renderClipboardIcon(e.closestToViewing.pathHome.slice())),$("#inChain").css("display","flex").css("align-items","end").css("gap","5px"),Tooltips.attach($("#inChain [data-tooltip]"))}else $("#inChain").text("")},this.renderRouteIcon=function(){const e="http://www.w3.org/2000/svg",i=document.createElementNS(e,"svg"),s=document.createElementNS(e,"g");return $(s).append(["M416 320h-96c-17.6 0-32-14.4-32-32s14.4-32 32-32h96s96-107 96-160-43-96-96-96-96 43-96 96c0 25.5 22.2 63.4 45.3 96H320c-52.9 0-96 43.1-96 96s43.1 96 96 96h96c17.6 0 32 14.4 32 32s-14.4 32-32 32H185.5c-16 24.8-33.8 47.7-47.3 64H416c52.9 0 96-43.1 96-96s-43.1-96-96-96zm0-256c17.7 0 32 14.3 32 32s-14.3 32-32 32-32-14.3-32-32 14.3-32 32-32zM96 256c-53 0-96 43-96 96s96 160 96 160 96-107 96-160-43-96-96-96zm0 128c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32z"].map(function(i){const s=document.createElementNS(e,"path");return $(s).attr("d",i).css("fill","#efefef"),s})),$(i).attr("viewBox","0 0 285.102 285.102").attr("version","1.1").css("height","15px").css("width","15px").css("display","inline-block").css("cursor","copy").append(s),i},this.renderClipboardIcon=function(e){const i=e.map(function(e){return e.name||null!=e.signatureID&&e.signatureID.substr(0,3).toUpperCase()||"???"}).join(" > "),s="http://www.w3.org/2000/svg",t=document.createElementNS(s,"svg"),a=document.createElementNS(s,"g");return $(a).append(["M220.741,46.137h-30.188v-5.785c0-7.444-6.056-13.5-13.5-13.5h-1.667 C172.294,11.554,158.748,0,142.552,0c-16.196,0-29.743,11.554-32.835,26.852h-1.669c-7.444,0-13.5,6.056-13.5,13.5v5.785H64.36 c-12.407,0-22.5,10.094-22.5,22.5v193.965c0,12.406,10.093,22.5,22.5,22.5h156.381c12.406,0,22.5-10.094,22.5-22.5V68.637 C243.241,56.23,233.148,46.137,220.741,46.137z M109.548,41.852h66.006v24.571h-66.006V41.852z M142.552,15 c7.856,0,14.566,4.931,17.245,11.852h-34.489C127.986,19.931,134.696,15,142.552,15z M228.241,262.602c0,4.136-3.364,7.5-7.5,7.5 H64.36c-4.136,0-7.5-3.364-7.5-7.5V68.637c0-4.136,3.364-7.5,7.5-7.5h30.188v6.786c0,7.444,6.056,13.5,13.5,13.5h69.006 c7.444,0,13.5-6.056,13.5-13.5v-6.786h30.188c4.136,0,7.5,3.364,7.5,7.5V262.602z","M193.212,107.931H91.89c-4.142,0-7.5,3.357-7.5,7.5c0,4.142,3.358,7.5,7.5,7.5h101.322 c4.143,0,7.5-3.358,7.5-7.5C200.712,111.288,197.355,107.931,193.212,107.931z","M193.212,145.26H91.89c-4.142,0-7.5,3.357-7.5,7.5c0,4.143,3.358,7.5,7.5,7.5h101.322 c4.143,0,7.5-3.357,7.5-7.5C200.712,148.617,197.355,145.26,193.212,145.26z","M193.212,182.591H91.89c-4.142,0-7.5,3.357-7.5,7.5c0,4.143,3.358,7.5,7.5,7.5h101.322 c4.143,0,7.5-3.357,7.5-7.5C200.712,185.948,197.355,182.591,193.212,182.591z","M193.212,231.263h-31.28c-4.143,0-7.5,3.357-7.5,7.5c0,4.143,3.357,7.5,7.5,7.5h31.28 c4.143,0,7.5-3.357,7.5-7.5C200.712,234.62,197.355,231.263,193.212,231.263z"].map(function(e){const i=document.createElementNS(s,"path");return $(i).attr("d",e).css("fill","#efefef"),i})),$(t).attr("viewBox","0 0 285.102 285.102").attr("version","1.1").css("height","15px").css("width","15px").css("display","inline-block").css("cursor","copy").append(a).click(function(){navigator.clipboard.writeText("Chain: "+i)}),t},this.updateCollapsed=function(i){options.chain.tabs[options.chain.active]&&(options.chain.tabs[options.chain.active].collapsed=i),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),e.activity(e.data.activity),e.occupied(e.data.occupied),e.flares(e.data.flares),e.grid(),options.save()}};
...
const automapState={pendingDecision:!1};tripwire.autoMapper=function(e,t){var i=[];if(!$("#toggle-automapper").hasClass("active")||$("#toggle-automapper").hasClass("disabled"))return!1;if(automapState.pendingDecision)return console.info("Not automapping because there is an automap dialog up"),!1;if(!tripwire.systems[e]||!tripwire.systems[t])return!1;if(e==t)return!1;if(tripwire.systems[e].regionID>12e6||tripwire.systems[t].regionID>12e6)return console.info("Not automapping into abyssal or other special space"),!1;if(tripwire.client.EVE&&tripwire.client.EVE.stationID)return!1;if(tripwire.client.EVE&&tripwire.client.EVE.shipTypeID&&$.inArray(parseInt(tripwire.client.EVE.shipTypeID),[33328,670])>=0)return!1;if(void 0!==tripwire.map.shortest[e-3e7]&&void 0!==tripwire.map.shortest[e-3e7][t-3e7])return!1;if($.map(tripwire.client.wormholes,function(i){const s=tripwire.client.signatures[i.initialID],r=tripwire.client.signatures[i.secondaryID];return s&&r&&(s.systemID==e&&r.systemID==t||s.systemID==t&&r.systemID==e)?i:null}).length>0)return!1;function s(e){return chain.data.map.rows.filter(t=>t.c[0].systemID==e).length>0}if(s(e)&&s(t))return console.info("Not automapping because both systems are already in chain"),!1;var r,n={signatures:{add:[],update:[]}};r=tripwire.systems[t].class?"Class-"+tripwire.systems[t].class:tripwire.systems[t].security>=.45?"High-Sec":tripwire.systems[t].security>0?"Low-Sec":"Null-Sec";var a=$.map(tripwire.client.wormholes,function(t){if(void 0!==tripwire.client.signatures[t.initialID]&&void 0!==tripwire.client.signatures[t.secondaryID]&&tripwire.client.signatures[t.initialID].systemID==e&&!tripwire.systems[tripwire.client.signatures[t.secondaryID].systemID]){if(appData.genericSystemTypes[tripwire.client.signatures[t.secondaryID].systemID]==r)return t;if(t.type&&appData.wormholes[t.type]&&appData.wormholes[t.type].leadsTo.replace(" ","-")==r)return t;if(!(null!==tripwire.client.signatures[t.secondaryID].systemID||t.type&&appData.wormholes[t.type]))return t}});if(a.length)if(a.length>1)$("#dialog-select-signature").dialog({autoOpen:!0,title:"Which Signature?",width:390,buttons:{Cancel:function(){$(this).dialog("close")},Ok:function(){var e=$("#dialog-select-signature [name=sig]:checked").val(),s=a[e],r=tripwire.client.signatures[s.initialID],o=tripwire.client.signatures[s.secondaryID];n.signatures.update.push({wormhole:{id:s.id},signatures:[{id:r.id},{id:o.id,systemID:t}]});tripwire.refresh("refresh",n,function(e){e.resultSet&&1==e.resultSet[0].result&&(i.push({wormhole:s,signatures:[r,o]}),$("#dialog-select-signature").dialog("close"))})}},open:function(){function i(e){const t=systemAnalysis.analyse(e);return systemRendering.renderSystem(t)}automapState.pendingDecision=!0,$("#dialog-select-signature .optionsTable tbody").empty(),document.getElementById("select-sig-from").innerHTML=i(e),document.getElementById("select-sig-to").innerHTML=i(t),$.each(a,function(e){const t=tripwire.client.signatures[a[e].initialID],i=tripwire.makeSigInfo(t,a[e]),s="<tr><td><input type='radio' name='sig' value='"+e+"' id='sig"+e+"' /></td><td class='centerAlign'>"+formatSignatureID(t.signatureID)+"</td><td class='centerAlign'>"+i.formattedType+"</td><td class='centerAlign'>"+i.leadsTo+"</td><td class='centerAlign "+a[e].life+"'>"+i.lifeText+"</td><td class='centerAlign "+a[e].mass+"'>"+a[e].mass+"</td></tr>",r=$(s);$(r).find("td").wrapInner("<label for='sig"+e+"' />"),$("#dialog-select-signature .optionsTable tbody").append(r)})},close:function(){automapState.pendingDecision=!1}});else{var o=a[0],l=tripwire.client.signatures[o.initialID],u=tripwire.client.signatures[o.secondaryID];n.signatures.update.push({wormhole:{id:o.id},signatures:[{id:l.id},{id:u.id,systemID:t}]}),i.push({wormhole:o,signatures:[l,u]})}else n.signatures.add.push({wormhole:{type:null,parent:"initial",life:"stable",mass:"stable"},signatures:[{systemID:e,type:"wormhole"},{systemID:t,type:"wormhole"}]});if(n.signatures.add.length||n.signatures.update.length){tripwire.refresh("refresh",n,function(e){e.resultSet&&1==e.resultSet[0].result&&($("#undo").removeClass("disabled"),e.results&&(viewingSystemID in tripwire.signatures.undo?tripwire.signatures.undo[viewingSystemID].push({action:"add",signatures:e.results}):tripwire.signatures.undo[viewingSystemID]=[{action:"add",signatures:e.results}]),i.length&&(viewingSystemID in tripwire.signatures.undo?tripwire.signatures.undo[viewingSystemID].push({action:"update",signatures:i}):tripwire.signatures.undo[viewingSystemID]=[{action:"update",signatures:i}]),sessionStorage.setItem("tripwire_undo",JSON.stringify(tripwire.signatures.undo)))})}};
...
appData.genericSystemTypes=["Null-Sec","Low-Sec","High-Sec","Class-1","Class-2","Class-3","Class-4","Class-5","Class-6","Class-13","Triglavian","C1","C2","C3","C4","C5","C6","C13","LS","HS","NS","TRIG"];
...
tripwire.systemChange=function(e,t){const s=systemAnalysis.analyse(e);if(s){"init"!=t&&($("#infoSecurity").removeClass(),$("#infoStatics").empty(),viewingSystem=s.name,viewingSystemID=e,activity.refresh(!0),$("#sigTable span[data-age]").countdown("destroy"),$("#sigTable tbody").empty(),$("#signature-count").html(0),tripwire.signatures.list={},tripwire.client.signatures=null,chain.redraw(),$("#notesWidget .content .comment:visible").remove(),tripwire.comments.data=null,history.replaceState(null,null,"?system="+viewingSystem),tripwire.refresh("change")),document.title=s.name+" - "+app_name,$("#infoSystem").text(s.name);var i=function(e){return window.location.origin+"/?journey&"+e+"="+s.name};if($("#journeyFrom").attr("href",i("from")),$("#journeyTo").attr("href",i("to")),-1!=$.inArray(parseInt(viewingSystemID),options.favorites)?$("#system-favorite").attr("data-icon","star").addClass("active"):$("#system-favorite").attr("data-icon","star-empty").removeClass("active"),s.class){if($("#infoSecurity").html("<span class='wh pointer'>Class "+s.class+"</span>"),s.effect){var a='<table cellpadding="0" cellspacing="1">';for(var r in tripwire.effects[s.effect]){var n=tripwire.effects[s.effect][r].name,o=tripwire.effects[s.effect][r].base,l=tripwire.effects[s.effect][r].bad,c=s.class>6?6:s.class,d=0;switch(Math.abs(o)){case 15:d=o>0?7:-7;break;case 30:d=o>0?14:-14;break;case 60:d=o>0?28:-28}a+="<tr><td>"+n+'</td><td style="padding-left: 25px; text-align: right;" class="'+(l?"critical":"stable")+'">',a+=o+d*(c-1)+"%</td></tr>"}a+="</table>",$("#infoSecurity").append("&nbsp;<span class='pointer' data-tooltip='"+a+"'>"+s.effect+"</span>")}for(var r in s.statics){var p=s.statics[r],f=appData.wormholes[p],m="wh";switch(f.leadsTo){case"High-Sec":m="hisec";break;case"Low-Sec":m="lowsec";break;case"Null-Sec":m="nullsec"}$("#infoStatics").append("<div><span class='"+m+"'>&#9679;</span> <b class='"+m+"'>"+f.leadsTo+"</b> via <span>"+wormholeRendering.renderWormholeType(f,p,s.genericSystemType)+"</span></div>")}$("#infoFaction").html("&nbsp;")}else{const e={HS:"High-Sec",LS:"Low-Sec",NS:"Null-Sec",Trig:"Triglavian"}[s.systemTypeName];for(var g in $("#infoSecurity").addClass(s.systemTypeClass).html(e+" "+s.baseSecurity.toFixed(2)+s.systemTypeModifiers.join(" ")),$("#infoFaction").html(s.factionID?tripwire.factions[s.factionID].name:"&nbsp;"),options.favorites){const e=options.favorites[g],t=guidance.findShortestPath(tripwire.map.shortest,e-3e7,viewingSystemID-3e7);t&&$("#infoStatics").append('<p><b><a href=".?system='+tripwire.systems[e].name+'">'+tripwire.systems[e].name+"</a></b>: "+systemRendering.renderPath(t)+"</p>")}}Tooltips.attach($("#infoStatics [data-tooltip]")),Tooltips.attach($("#infoSecurity [data-tooltip]")),$("#infoRegion").text(tripwire.regions[s.regionID].name),$("#infoWidget .infoLink").each(function(){this.href=$(this).data("href").replace(/\$systemName/gi,s.name).replace(/\$systemID/gi,e)}),tripwire.signatures.undo[e]&&tripwire.signatures.undo[e].length>0?$("#undo").removeClass("disabled"):$("#undo").addClass("disabled"),tripwire.signatures.redo[e]&&tripwire.signatures.redo[e].length>0?$("#redo").removeClass("disabled"):$("#redo").addClass("disabled"),0==$("#sigTable tr.selected").length?$("#signaturesWidget #delete-signature").addClass("disabled"):$("#signaturesWidget #delete-signature").removeClass("disabled")}},tripwire.systemChange(viewingSystemID,"init");
...
wormholeAnalysis=new function(){this.targetSystemID=function(e,t){const n=e||(appData.wormholes[(t+"").toUpperCase()]||{}).leadsTo;return n?Object.index(appData.systems,"name",n,!0)?Object.index(appData.systems,"name",n,!0):t&&appData.wormholes[t.toUpperCase()]?appData.genericSystemTypes.findIndex(e=>n.replace(" ","-").toLowerCase()===e.toLowerCase())>-1?appData.genericSystemTypes.findIndex(e=>n.replace(" ","-").toLowerCase()===e.toLowerCase()):void 0:-1!==appData.genericSystemTypes.findIndex(e=>n.toLowerCase()===e.toLowerCase())?appData.genericSystemTypes.findIndex(t=>e.toLowerCase()===t.toLowerCase()):null:null},this.eligibleWormholeTypes=function(e,t,n){const s=function(e){return null==e||e.genericSystemType?e:systemAnalysis.analyse(e)},o=s(e),a=s(t);if(!o&&!a)return null;const r=[],p=[],i=function(e,t,n){return"string"==typeof e&&(e=[e]),!n||(!e||e.indexOf(n.name)>=0||e.indexOf(n.genericSystemType)>=0)&&(!t||t.indexOf(n.genericSystemType)<0)};return Object.entries(n||appData.wormholes).forEach(function(e){const t=e[1],n=e[0];i(t.from,t.notFrom,o)&&i(t.leadsTo,t.notLeadsTo,a)&&r.push(Object.assign({key:n},t)),i(t.from,t.notFrom,a)&&i(t.leadsTo,t.notLeadsTo,o)&&p.push(Object.assign({key:n},t))}),{from:r,to:p}}};
