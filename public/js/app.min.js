Object.sort=function(t,e){var n,r;do{for(var i in n=!1,r=null,t){if(r&&Number(t[i][e])<Number(t[r][e])){var a=t[i];t[i]=t[r],t[r]=a,n=!0}r=i}}while(n)},Object.index=function(t,e,n,r){for(var i in t){if(!r&&t[i][e]==n)return i;if(t[i][e]&&t[i][e].toLowerCase()==n.toLowerCase())return i}},Object.find=function(t,e,n,r){for(var i in t){if(!r&&t[i][e]==n)return t[i];if(t[i][e]&&t[i][e].toLowerCase()==n.toLowerCase())return t[i]}return!1},function(t){t.fn.serializeObject=function(){var e=this,n={},r={},i={validate:/^[a-zA-Z][a-zA-Z0-9_]*(?:\[(?:\d*|[a-zA-Z0-9_]+)\])*$/,key:/[a-zA-Z0-9_]+|(?=\[\])/g,push:/^$/,fixed:/^\d+$/,named:/^[a-zA-Z0-9_]+$/};return this.build=function(t,e,n){return t[e]=n,t},this.push_counter=function(t){return void 0===r[t]&&(r[t]=0),r[t]++},t.each(t(this).serializeArray(),function(){if(i.validate.test(this.name)){for(var r,a=this.name.match(i.key),o=this.value,u=this.name;void 0!==(r=a.pop());)u=u.replace(new RegExp("\\["+r+"\\]$"),""),r.match(i.push)?o=e.build([],e.push_counter(u),o):r.match(i.fixed)?o=e.build([],r,o):r.match(i.named)&&(o=e.build({},r,o));n=t.extend(!0,n,o)}}),n}}(jQuery);var letterToNumbers=function(t){t=t.toUpperCase();var e,n="ABCDEFGHIJKLMNOPQRSTUVWXYZ",r=0;for(e=0;e<t.length;e++)r+=Math.pow(n.length,e)*(n.indexOf(t.substr(-1*(e+1),1))+1);return r};function positionRelativeTo(t,e){const n=t.getBoundingClientRect(),r=e.getBoundingClientRect();return{left:n.left-r.left+e.scrollLeft,top:n.top-r.top+e.scrollTop}}function lookupMultiple(t,e,n,r){const i=n.split(","),a=[];for(var o=0;o<i.length;o++){const n=i[o],u=t[n];if(!u){if(r)return;throw"Value "+n+" did not match anything in "+t}a.push(u[e])}return a.join(",")}!function(t){var e=t.fn.addClass,n=t.fn.removeClass;t.fn.addClass=function(t){var n=e.apply(this,arguments);return this.trigger("classchange",t),n},t.fn.removeClass=function(t){var e=n.apply(this,arguments);return this.trigger("classchange",t),e}}(jQuery);
...
var guidance=function(e){var r=function(e,r){return parseFloat(e)-parseFloat(r)};function n(e,r){var n=systemAnalysis.analyse(3e7+1*r);if(!n)return e;switch(options.chain.routeIgnore.enabled&&options.chain.routeIgnore.systems.indexOf(n.name)>=0&&(e+=100),options.chain.routeSecurity){case"highsec":return e+(n.security<.45?100:0);case"avoid-high":return e+(n.security>=.45?100:0);case"avoid-null":return e+(n.security<=0?100:0);default:return e}}function t(e,r,n){return a.jumpCostModifiers.reduce((n,t)=>t(e,r,n),n)}var i=function(e,i,a,c){Array.isArray(i)||(i=[i]),Array.isArray(a)||(a=[a]),i=i.filter(function(r){return e[r]});const u=(a=a.filter(function(r){return e[r]})).filter(function(e){return i.indexOf(e)>=0});if(u.length)return[u[0]];var s,f={},h={0:[]},l={};i.forEach(function(e){f[e]=0,h[0].push(e)});for(var d=function(e,r){var n=""+e;h[n]||(h[n]=[]),h[n].push(r)};(s=Object.keys(h)).length;){s.sort(r);var p=s[0],v=h[p],y=v.shift(),g=parseFloat(p),m=e[y]||{};if(v.length||delete h[p],g>=c)break;for(var k in m){const e=1*k;if(void 0!==m[e]){var C=1+n(m[e],e),S=C+g,j=f[e];if(((C=t(y,e,C))>0&&void 0===j||j>S)&&(f[e]=S,d(S,e),l[e]=y,a.indexOf(e)>=0))return o(l,e)}}}return null},o=function(e,r){for(var n=[],t=r;t;)n.push(t),predecessor=e[t],t=e[t];return n.reverse(),n},a={kSpaceCache:{},jumpCostModifiers:[],clearCache:function(){a.kSpaceCache={}},findShortestPath:function(e,r,n,t){r>3e7&&(r-=3e7),n>3e7&&(n-=3e7);const o=[r,n].join(",")+(t?"-"+t:""),c=a.kSpaceCache[o];return void 0===c?a.kSpaceCache[o]=i(e,r,n,t):c},connections:function(e,r){return r>3e7&&(r-=3e7),Object.keys(e[r]||{}).map(e=>1*e).map(e=>{const n={systemID:e+3e7};return 0>t(r,e,1)&&(n.closed=!0),n})}};return a}();
...
var chain=new function(){var e=this;this.map,this.view,this.drawing,this.data={},thirdPartySuppliers=[eveScout];const s={orgChart:new ChainMapRendererOrgchart(this),radial:new ChainMapRendererRadial(this)};this.renderer=s[options.chain.renderer],this.renderer.switchTo(),this.useRenderer=function(e){if(!s[e])throw"Unknown renderer "+e;this.renderer!=s[e]&&(this.renderer.switchFrom(),this.renderer=s[e],this.renderer.switchTo(),this.redraw())},this.activity=function(e){for(var s=0,i=(t=document.querySelectorAll("#chainMap .nodeActivity span")).length;s<i;++s)t[s].className=t[s].className+" invisible";var t;for(s=0,i=(t=document.querySelectorAll("#chainMap [data-nodeid]")).length;s<i;++s){var a=t[s].getAttribute("data-nodeid");if(e[a]){var n=e[a].shipJumps,r=e[a].podKills,c=e[a].shipKills,o=e[a].npcKills,l=t[s].getElementsByClassName("nodeActivity")[0];if(n>0){var d=l.getElementsByClassName("jumps")[0];d.className=d.className.replace(/invisible/g,""),d.setAttribute("data-tooltip",n+" Jumps")}if(r>0){var h=l.getElementsByClassName("pods")[0];h.className=h.className.replace(/invisible/g,""),h.setAttribute("data-tooltip",r+" Pod Kills")}if(c>0){var p=l.getElementsByClassName("ships")[0];p.className=p.className.replace(/invisible/g,""),p.setAttribute("data-tooltip",c+" Ship Kills")}if(o>0){var m=l.getElementsByClassName("npcs")[0];m.className=m.className.replace(/invisible/g,""),m.setAttribute("data-tooltip",o+" NPC Kills")}}}return SystemActivityToolTips.attachedElements&&SystemActivityToolTips.attachedElements.length>0&&SystemActivityToolTips.detach($("#chainMap .whEffect")),SystemActivityToolTips.attach($("#chainMap .nodeActivity > span[data-tooltip]:not(.invisible)")),e},this.occupied=function(e){for(var s in $("#chainMap [data-icon='user'], #chainMap [data-icon='user'] + .badge").addClass("invisible"),e)$("#chainMap [data-nodeid='"+e[s].systemID+"'] [data-icon='user']").removeClass("invisible"),$("#chainMap [data-nodeid='"+e[s].systemID+"'] [data-icon='user'] + .badge").removeClass("invisible").html(e[s].count);return OccupiedToolTips.attach($("#chainMap [data-icon='user']:not(.invisible)")),e},this.flares=function(e){if($("#chainMap div.node").removeClass("redNode yellowNode greenNode"),$("#chainGrid tr").removeClass("red yellow green"),e)for(var s in e.flares){var i=e.flares[s].systemID,t=e.flares[s].flare,a=($("#chainMap [data-nodeid="+i+"]").addClass(t+"Node").parent().index()-1)/3*2;a>0&&$("#chainGrid tr:eq("+a+")").addClass(t).next().addClass(t)}return e},this.grid=function(){if(0==options.chain.gridlines)return $("#chainGrid tr").addClass("hidden"),!1;$("#chainGrid tr").removeClass("hidden");var e=Math.max(0,2*$(".google-visualization-orgchart-table tr:has(.node)").length-1);$("#chainGrid tr:gt("+e+")").addClass("hidden")},this.nodes=function(e){var s={cols:[{label:"System",type:"string"},{label:"Parent",type:"string"}],rows:[]},i=[];function t(e,s){if(!e||!tripwire.systems[e])return!1;const i=options.chain.tabs[options.chain.active];return a(e,s,null,null,i&&0!=i.systemID&&0>i.systemID.indexOf(",")?options.chain.tabs[options.chain.active].name:void 0,"&nbsp;",["top-level"])}function a(e,s,i,t,a,n,r){const c=systemAnalysis.analyse(e);var o="<span class='"+c.systemTypeClass+"'>"+c.systemTypeName+c.systemTypeModifiers.join("")+"</span>";a=_.escape(a);const l="name"==options.chain.sigNameLocation?a||(c.name?c.name:"&nbsp;"):"name_prefix"==options.chain.sigNameLocation&&a?a+(c.name?" - "+c.name:""):c.name?c.name:"&nbsp;";var d={v:s,systemID:e},h="<div id='node"+s+"' data-nodeid='"+e+"'"+(i?" data-sigid='"+i+"'":"")+(t?" data-inSigid='"+t+"'":"")+" class='node "+(r||[]).join(" ")+"'><div class='nodeIcons'><div style='float: left;'>"+systemRendering.renderEffect(c,"i")+"</div><div style='float: right;'><i data-icon='user' class='invisible'></i><span class='badge invisible'></span></div></div><h4 class='nodeClass'>"+o+"</h4><h4 class='nodeSystem'>"+(c.name?"<a href='.?system="+c.name+"'>"+l+"</a>":l)+"</h4><h4 class='nodeType'>"+n+"</h4><div class='statics'>"+function(e){if(!e)return"";if(e.length>4)return'<span class="multi-static">+</span>';const s={"High-Sec":"H","Low-Sec":"L","Null-Sec":"N",Triglavian:"▼","Class-1":"1","Class-2":"2","Class-3":"3","Class-4":"4","Class-5":5,"Class-6":6},i={H:"hisec",L:"lowsec",N:"nullsec","▼":"triglavian"};return e.map(function(e){const t=s[appData.wormholes[e].leadsTo];return'<span class="'+(i[t]||"class-"+t)+'" data-tooltip="'+appData.wormholes[e].leadsTo+" via "+e+'">'+t+"</span>"}).join("")}(c.name?c.statics:[])+"</div><div class='nodeActivity'><span class='jumps invisible'>&#9679;</span>&nbsp;<span class='pods invisible'>&#9679;</span>&nbsp;&nbsp;<span class='ships invisible'>&#9679;</span>&nbsp;<span class='npcs invisible'>&#9679;</span></div></div>";return d.f=h,d}function n(e,s,i){var t=guidance.findShortestPath(tripwire.map.shortest,i-3e7,s.child.systemID-3e7);if(!t)return null;var a={calculated:!0,life:"Gate",parent:{}};return a.parent.id=s.child.id,a.parent.systemID=s.child.systemID,a.parent.name=s.child.name,a.parent.type=s.child.type,a.parent.nth=s.child.nth,a.child={},a.child.id=++e,a.child.systemID=i,a.child.name=tripwire.systems[i].name,a.child.path=t,a.child.jumps=t.length-1,a.child.nth=null,{childID:e,calcNode:a}}function r(e){if(e[0]<=0)return!1;var s=parseInt(e[1]),i=o.length;const t=[],a=function(e){$("#show-viewing").hasClass("active")&&tripwire.systems[e.child.systemID]&&!tripwire.systems[viewingSystemID].class&&!tripwire.systems[e.child.systemID].class&&viewingSystemID!=e.child.systemID&&((t=n(i,e,viewingSystemID))&&(i=t.childID,d.push(t.calcNode),o.push([0,i])));if($("#show-favorite").hasClass("active")&&tripwire.systems[e.child.systemID]&&!tripwire.systems[e.child.systemID].class)for(var s in options.favorites){var t;if(!(tripwire.systems[options.favorites[s]].regionID>=11e6||tripwire.systems[e.child.systemID].regionID>=11e6||options.favorites[s]==e.child.systemID))(t=n(i,e,options.favorites[s]))&&(i=t.childID,d.push(t.calcNode),o.push([0,i]))}};for(var r in l){var c=l[r];if(-1==$.inArray(c.id,h)){var p,m,u,y,v,f,g;if("secondary"==c.parent?(p=tripwire.client.signatures[c.secondaryID],m=tripwire.client.signatures[c.initialID]):(p=tripwire.client.signatures[c.initialID],m=tripwire.client.signatures[c.secondaryID]),u=c.type,"K162",p&&p.systemID==e[0])y=p,v=m,f="K162",g=u;else{if(!m||m.systemID!=e[0])continue;y=m,v=p,g="K162",f=u}var w={};w.id=c.id,w.life=c.life,w.mass=c.mass,w.time=y.modifiedTime,w.parent={},w.parent.id=s,w.parent.systemID=tripwire.systems[y.systemID]?y.systemID:y.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),w.parent.name=v.name,w.parent.type=f,w.parent.nth=null,w.parent.signatureID=v.signatureID,w.parent.sigIndex=v.id,w.child={},w.child.id=++i,w.child.systemID=tripwire.systems[v.systemID]?v.systemID:v.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),w.child.name=y.name,w.child.type=g,w.child.nth=null,w.child.signatureID=y.signatureID,w.child.sigIndex=y.id,d.push(w),o.push([w.child.systemID,w.child.id,e[2]]),h.push(w.id),tripwire.systems[v.systemID]&&t.push(1*v.systemID),a(w)}}thirdPartySuppliers.forEach(function(n){const r={parentID:s,nextChildID:++i},c=n.findLinks(1*e[0],r);if(c){i=r.nextChildID-1;for(var l=0;l<c.length;l++){var p=c[l];0>h.indexOf(p.id)&&(0>t.indexOf(p.child.systemID)&&(p.thirdParty=n.nodeNameSuffix,d.push(p),o.push([p.child.systemID,p.child.id,e[2]]),t.push(p.child.systemID),a(p)),h.push(p.id))}}})}if($("#chainTabs .current").length>0){var c=$("#chainTabs .current .name").data("tab").toString().split(","),o=[],l=e,d=[],h=[];if(0==c){let i=0;Object.keys(e).slice().forEach(a=>{const n=tripwire.client.signatures[e[a].initialID],r=tripwire.client.signatures[e[a].secondaryID];n&&tripwire.systems[n.systemID]&&void 0===tripwire.systems[n.systemID].class?(i++,s.rows.push({c:[t(n.systemID,i),{v:null}]}),o.push([n.systemID,i,n.systemID])):r&&tripwire.systems[r.systemID]&&void 0===tripwire.systems[r.systemID].class&&(i++,s.rows.push({c:[t(r.systemID,i),{v:null}]}),o.push([r.systemID,i,r.systemID]))})}else for(var p in c)s.rows.push({c:[t(c[p],parseInt(p)+1),{v:null}]}),o.push([c[p],parseInt(p)+1,c[p]]);for(var m=0;m<o.length;m++)r(o[m])}else{$("#chainError").hide();var u={c:[]},y=viewingSystemID;u.c.push(t(y,1),{v:null}),s.rows.push(u);for(o=[[y,1]],l=e,d=[],h=[],m=0;m<o.length;++m)r(o[m])}const v={};for(var p in d){var f=d[p];u={c:[]};const e="id"==options.chain["node-reference"]?f.child.signatureID?f.child.signatureID.substring(0,3):"???":f.child.type||"(?)",t=f.child.path?systemRendering.renderPath(f.child.path):(f.child.sigIndex?"<a href='#' onclick='sigDialog.openSignatureDialog({data: { signature: "+f.child.sigIndex+', mode: "update" }}); return false;\'>':"")+_.escape(f.child.name&&"ref"==options.chain.sigNameLocation?f.child.name:f.child.name&&"ref_prefix"==options.chain.sigNameLocation?f.child.name+" - "+e:e)+(f.child.sigIndex?"</a>":""),n=f.calculated?["calc"]:v[f.child.systemID]?["loop"]:[];f.thirdParty&&n.push("third-party","third-party-"+f.thirdParty);var g=[];"critical"==f.life&&g.push("eol"),"critical"==f.mass?g.push("critical"):"destab"==f.mass&&g.push("destab");const r=wormholeAnalysis.wormholeFromTypePair(f.parent.type,f.child.type)||wormholeAnalysis.likelyWormhole(f.parent.systemID,f.child.systemID);r.jump&&(g.push("jm-"+r.jump/1e6+"kt"),5e6==r.jump&&g.push("frig"));const c=(v[f.parent.systemID]||{chainModifiers:[]}).chainModifiers;u.chainModifiers=g.concat(c.filter(function(e){return g.indexOf(e)<0})),u.chainModifiers.forEach(function(e){g.push(e+"-chain")});const o=a(f.child.systemID,f.child.id,f.id,f.child.sigIndex,f.child.name,t,n.concat(g));var w={v:f.parent.id};u.c.push(o,w),s.rows.push(u),i.push(Array(o.v,w.v,g,f.id));const l=(v[f.parent.systemID]||{pathHome:[]}).pathHome;u.pathHome=l.concat(f.child),f.calculated||(v[f.child.systemID]=u)}i.reverse();const I=Object.keys(v).filter(function(e){return e<31e6});return{map:s,lines:i,systemsInChainMap:v,exits:I}},this.setActiveTab=function(s){$("#chainTabs .tab").removeClass("current"),options.chain.active=s,null!=s&&$("#chainTabs .tab").eq(s).addClass("current"),options.save(),e.redraw(),tripwire.parse(tripwire.client,"refresh")},this.redraw=function(){this.useRenderer(options.chain.renderer);var e=$.extend(!0,{},this.data);e.map=$.extend(!0,{},e.rawMap),this.draw(e)};var i=null;this.draw=function(s){s=void 0!==s?s:{};if(clearTimeout(i),!this.renderer.ready()||Object.keys(s.map||{}).length&&!tripwire.client.signatures)i=setTimeout(function(){e.draw(s)},100);else{if(s.map){this.drawing=!0,this.data.rawMap=$.extend(!0,{},s.map),Object.sort(s.map,"id"),$.extend(s,this.nodes(s.map)),$.extend(this.data,s);const e=options.chain.tabs[options.chain.active]&&options.chain.tabs[options.chain.active].collapsed||[];this.renderer.draw(s.map,s.lines,e),this.grid(),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),WormholeRouteToolTips.attach($("#chainMap .path span[data-tooltip]")),SystemActivityToolTips.attach($("#chainMap .nodeClass span[data-tooltip]")),this.renderInChain(s),this.drawing=!1,systemPanel.update()}!this.data.activity||new Date>this.data.activity.expires?(s.activity={},tripwire.esi.universeJumps().done(function(e,i,t){s.activity.expires=new Date(t.getResponseHeader("expires")),$.each(e,function(i){s.activity[e[i].system_id]={systemID:e[i].system_id,shipJumps:e[i].ship_jumps}})}).then(function(){return tripwire.esi.universeKills().done(function(e){$.each(e,function(i){s.activity[e[i].system_id]?(s.activity[e[i].system_id].podKills=e[i].pod_kills,s.activity[e[i].system_id].shipKills=e[i].ship_kills,s.activity[e[i].system_id].npcKills=e[i].npc_kills):s.activity[e[i].system_id]={systemID:e[i].system_id,podKills:e[i].pod_kills,shipKills:e[i].ship_kills,npcKills:e[i].npc_kills}})})}).then(function(){e.data.activity=e.activity(s.activity)})):s.map&&e.activity(this.data.activity),s.occupied&&(this.data.occupied=this.occupied(s.occupied)),s.flares&&(this.data.flares=this.flares(s.flares))}},this.renderInChain=function(e){if(e.closestToViewing){const s=e.closestToViewing.pathLength<=1,i=s?"In chain: ":e.closestToViewing.pathLength-1+"j from ",t=e.closestToViewing.pathHome.slice().map(function(e){return'<a href=".?system='+tripwire.systems[e.systemID].name+'">'+(e.name||null!=e.signatureID&&e.signatureID.substr(0,3).toUpperCase()||"???")+"</a>"}).join(" &gt; "),a=s?"":"<br/>"+systemRendering.renderPath(guidance.findShortestPath(tripwire.map.shortest,e.closestToViewing.systemID-3e7,viewingSystemID-3e7));$("#inChain").html(i+t+a),$("#inChain").append(this.renderClipboardIcon(e.closestToViewing.pathHome.slice())),$("#inChain").css("display","flex").css("align-items","end").css("gap","5px"),Tooltips.attach($("#inChain [data-tooltip]"))}else $("#inChain").text("")},this.renderRouteIcon=function(){const e="http://www.w3.org/2000/svg",s=document.createElementNS(e,"svg"),i=document.createElementNS(e,"g");return $(i).append(["M416 320h-96c-17.6 0-32-14.4-32-32s14.4-32 32-32h96s96-107 96-160-43-96-96-96-96 43-96 96c0 25.5 22.2 63.4 45.3 96H320c-52.9 0-96 43.1-96 96s43.1 96 96 96h96c17.6 0 32 14.4 32 32s-14.4 32-32 32H185.5c-16 24.8-33.8 47.7-47.3 64H416c52.9 0 96-43.1 96-96s-43.1-96-96-96zm0-256c17.7 0 32 14.3 32 32s-14.3 32-32 32-32-14.3-32-32 14.3-32 32-32zM96 256c-53 0-96 43-96 96s96 160 96 160 96-107 96-160-43-96-96-96zm0 128c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32z"].map(function(s){const i=document.createElementNS(e,"path");return $(i).attr("d",s).css("fill","#efefef"),i})),$(s).attr("viewBox","0 0 285.102 285.102").attr("version","1.1").css("height","15px").css("width","15px").css("display","inline-block").css("cursor","copy").append(i),s},this.renderClipboardIcon=function(e){const s=e.map(function(e){return e.name||null!=e.signatureID&&e.signatureID.substr(0,3).toUpperCase()||"???"}).join(" > "),i="http://www.w3.org/2000/svg",t=document.createElementNS(i,"svg"),a=document.createElementNS(i,"g");return $(a).append(["M220.741,46.137h-30.188v-5.785c0-7.444-6.056-13.5-13.5-13.5h-1.667 C172.294,11.554,158.748,0,142.552,0c-16.196,0-29.743,11.554-32.835,26.852h-1.669c-7.444,0-13.5,6.056-13.5,13.5v5.785H64.36 c-12.407,0-22.5,10.094-22.5,22.5v193.965c0,12.406,10.093,22.5,22.5,22.5h156.381c12.406,0,22.5-10.094,22.5-22.5V68.637 C243.241,56.23,233.148,46.137,220.741,46.137z M109.548,41.852h66.006v24.571h-66.006V41.852z M142.552,15 c7.856,0,14.566,4.931,17.245,11.852h-34.489C127.986,19.931,134.696,15,142.552,15z M228.241,262.602c0,4.136-3.364,7.5-7.5,7.5 H64.36c-4.136,0-7.5-3.364-7.5-7.5V68.637c0-4.136,3.364-7.5,7.5-7.5h30.188v6.786c0,7.444,6.056,13.5,13.5,13.5h69.006 c7.444,0,13.5-6.056,13.5-13.5v-6.786h30.188c4.136,0,7.5,3.364,7.5,7.5V262.602z","M193.212,107.931H91.89c-4.142,0-7.5,3.357-7.5,7.5c0,4.142,3.358,7.5,7.5,7.5h101.322 c4.143,0,7.5-3.358,7.5-7.5C200.712,111.288,197.355,107.931,193.212,107.931z","M193.212,145.26H91.89c-4.142,0-7.5,3.357-7.5,7.5c0,4.143,3.358,7.5,7.5,7.5h101.322 c4.143,0,7.5-3.357,7.5-7.5C200.712,148.617,197.355,145.26,193.212,145.26z","M193.212,182.591H91.89c-4.142,0-7.5,3.357-7.5,7.5c0,4.143,3.358,7.5,7.5,7.5h101.322 c4.143,0,7.5-3.357,7.5-7.5C200.712,185.948,197.355,182.591,193.212,182.591z","M193.212,231.263h-31.28c-4.143,0-7.5,3.357-7.5,7.5c0,4.143,3.357,7.5,7.5,7.5h31.28 c4.143,0,7.5-3.357,7.5-7.5C200.712,234.62,197.355,231.263,193.212,231.263z"].map(function(e){const s=document.createElementNS(i,"path");return $(s).attr("d",e).css("fill","#efefef"),s})),$(t).attr("viewBox","0 0 285.102 285.102").attr("version","1.1").css("height","15px").css("width","15px").css("display","inline-block").css("cursor","copy").append(a).click(function(){navigator.clipboard.writeText("Chain: "+s)}),t},this.updateCollapsed=function(s){options.chain.tabs[options.chain.active]&&(options.chain.tabs[options.chain.active].collapsed=s),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),e.activity(e.data.activity),e.occupied(e.data.occupied),e.flares(e.data.flares),e.grid(),options.save()}};
...
const systemPanel=new function(){function t(t,a,c,i){const r=t?guidance.findShortestPath(tripwire.map.shortest,viewingSystemID-3e7,t):null;if(r){const t=r.length<=1,o=r[r.length-1]+3e7,h=t?"":r.length-1+"j from ",u=a?chain.data.systemsInChainMap[o].pathHome.slice().map(n):[{link:".?system="+tripwire.systems[o].name,text:tripwire.systems[o].name}];var p=$("<div/>").addClass(c).append(i).append(": ").append(h);return e(u).forEach(function(t){$(p).append(t)}),a&&$(p).append(s(u)),p}{if(!chain.data.systemsInChainMap[viewingSystemID]||!a)return null;const t=a?chain.data.systemsInChainMap[viewingSystemID].pathHome.slice().map(n):[];p=$("<div/>").addClass(c).append(i).append(": ");return e(t).forEach(function(t){$(p).append(t)}),$(p).append(s(t)),p}}function e(t){var e=[];return t.forEach(function(n,s){e.push(a(n.link,n.text)),s<t.length-1&&e.push($("<span/>").text(" > "))}),e}function n(t){var e=t.name;return null==e&&(e=t.signatureID.toUpperCase().substring(0,3)),null==e&&(e="???"),{link:".?system="+tripwire.systems[t.systemID].name,text:e}}function a(t,e,n=!1){var a=$("<a/>").attr("href",t).text(e);return 1==n&&$(a).attr("target","_blank"),a}function s(t){const e=t.map(function(t){return t.text}).join(" > "),n="http://www.w3.org/2000/svg",a=document.createElementNS(n,"svg"),s=document.createElementNS(n,"g");return $(s).append(["M220.741,46.137h-30.188v-5.785c0-7.444-6.056-13.5-13.5-13.5h-1.667 C172.294,11.554,158.748,0,142.552,0c-16.196,0-29.743,11.554-32.835,26.852h-1.669c-7.444,0-13.5,6.056-13.5,13.5v5.785H64.36 c-12.407,0-22.5,10.094-22.5,22.5v193.965c0,12.406,10.093,22.5,22.5,22.5h156.381c12.406,0,22.5-10.094,22.5-22.5V68.637 C243.241,56.23,233.148,46.137,220.741,46.137z M109.548,41.852h66.006v24.571h-66.006V41.852z M142.552,15 c7.856,0,14.566,4.931,17.245,11.852h-34.489C127.986,19.931,134.696,15,142.552,15z M228.241,262.602c0,4.136-3.364,7.5-7.5,7.5 H64.36c-4.136,0-7.5-3.364-7.5-7.5V68.637c0-4.136,3.364-7.5,7.5-7.5h30.188v6.786c0,7.444,6.056,13.5,13.5,13.5h69.006 c7.444,0,13.5-6.056,13.5-13.5v-6.786h30.188c4.136,0,7.5,3.364,7.5,7.5V262.602z","M193.212,107.931H91.89c-4.142,0-7.5,3.357-7.5,7.5c0,4.142,3.358,7.5,7.5,7.5h101.322 c4.143,0,7.5-3.358,7.5-7.5C200.712,111.288,197.355,107.931,193.212,107.931z","M193.212,145.26H91.89c-4.142,0-7.5,3.357-7.5,7.5c0,4.143,3.358,7.5,7.5,7.5h101.322 c4.143,0,7.5-3.357,7.5-7.5C200.712,148.617,197.355,145.26,193.212,145.26z","M193.212,182.591H91.89c-4.142,0-7.5,3.357-7.5,7.5c0,4.143,3.358,7.5,7.5,7.5h101.322 c4.143,0,7.5-3.357,7.5-7.5C200.712,185.948,197.355,182.591,193.212,182.591z","M193.212,231.263h-31.28c-4.143,0-7.5,3.357-7.5,7.5c0,4.143,3.357,7.5,7.5,7.5h31.28 c4.143,0,7.5-3.357,7.5-7.5C200.712,234.62,197.355,231.263,193.212,231.263z"].map(function(t){const e=document.createElementNS(n,"path");return $(e).attr("d",t).css("fill","#efefef"),e})),$(a).attr("viewBox","0 0 285.102 285.102").attr("version","1.1").css("height","10px").css("width","10px").css("display","inline-block").css("cursor","copy").css("margin","0 5px 0 5px").append(s).click(function(){navigator.clipboard.writeText("Chain: "+e)}),$(a)}this.update=function(){const e=t((chain.data.exits||[]).map(function(t){return t-3e7}),!0,"chain","To Target"),n=t(guidance_profiles.blueLootSystems,!1,"blue-loot","Blue loot buyer");var s;$("#infoExtra").empty(),$("#infoExtra").append((s=tripwire.systems[viewingSystemID].name,$("<div/>").append("Journey Planner: ").append(a("?journey&from="+s,"From",!0)).append(" - ").append(a("?journey&to="+s,"To",!0)).append(function(){const t="http://www.w3.org/2000/svg",e=document.createElementNS(t,"svg"),n=document.createElementNS(t,"g");return $(n).append(["M416 320h-96c-17.6 0-32-14.4-32-32s14.4-32 32-32h96s96-107 96-160-43-96-96-96-96 43-96 96c0 25.5 22.2 63.4 45.3 96H320c-52.9 0-96 43.1-96 96s43.1 96 96 96h96c17.6 0 32 14.4 32 32s-14.4 32-32 32H185.5c-16 24.8-33.8 47.7-47.3 64H416c52.9 0 96-43.1 96-96s-43.1-96-96-96zm0-256c17.7 0 32 14.3 32 32s-14.3 32-32 32-32-14.3-32-32 14.3-32 32-32zM96 256c-53 0-96 43-96 96s96 160 96 160 96-107 96-160-43-96-96-96zm0 128c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32z"].map(function(e){const n=document.createElementNS(t,"path");return $(n).attr("d",e).css("fill","#efefef"),n})),$(e).attr("viewBox","0 0 490 490").attr("version","1.1").css("height","10px").css("width","10px").css("display","inline-block").css("margin","0 5px 0 5px").append(n),e}()))),$("#infoExtra").append(e),$("#infoExtra").append(n),Tooltips.attach($("#infoExtra [data-tooltip]"))}};
...
appData.genericSystemTypes=["Null-Sec","Low-Sec","High-Sec","Class-1","Class-2","Class-3","Class-4","Class-5","Class-6","Class-13","Triglavian","Unknown","Unknown (small)","Dangerous"];
...
const wormholeAnalysis=new function(){function e(e,s){return e&&Object.assign({key:s},e)}this.targetSystemID=function(e,s){const o=e||(appData.wormholes[(s+"").toUpperCase()]||{}).leadsTo;return o?Object.index(appData.systems,"name",o,!0)?Object.index(appData.systems,"name",o,!0):s&&appData.wormholes[s.toUpperCase()]?appData.genericSystemTypes.findIndex(e=>o.replace(" ","-").toLowerCase()===e.toLowerCase())>-1?appData.genericSystemTypes.findIndex(e=>o.replace(" ","-").toLowerCase()===e.toLowerCase()):void 0:-1!==appData.genericSystemTypes.findIndex(e=>o.toLowerCase()===e.toLowerCase())?appData.genericSystemTypes.findIndex(s=>e.toLowerCase()===s.toLowerCase()):null:null},this.eligibleWormholeTypes=function(s,o,n){const t=function(e){return null==e||e.genericSystemType?e:systemAnalysis.analyse(e)},a=t(s),r=t(o);if(!a&&!r)return null;const i=[],l=[],m=function(e,s,o){return"string"==typeof e&&(e=[e]),!o||(!e||e.indexOf(o.name)>=0||function(e,s){return s.some(s=>e.indexOf(s)>=0||s.indexOf("/")>=0&&_.some(s.substring("Class-".length).split("/"),s=>e.indexOf("Class-"+s)>=0))}(e,o.genericSystemType))&&(!s||s.indexOf(o.genericSystemType)<0)};return Object.entries(n||appData.wormholes).forEach(function(s){const o=s[1],n=s[0];m(o.from,o.notFrom,a)&&m(o.leadsTo,o.notLeadsTo,r)&&i.push(e(o,n)),m(o.from,o.notFrom,r)&&m(o.leadsTo,o.notLeadsTo,a)&&l.push(e(o,n))}),{from:i,to:l}},this.dummyWormholes={GATE:{from:["Null-Sec","Low-Sec","High-Sec","Triglavian"],leadsTo:["Null-Sec","Low-Sec","High-Sec","Triglavian"]},SML:{jump:5e6},MED:{jump:62e6},LRG:{jump:375e6},XLG:{jump:2e9}},this.wormholeFromTypePair=function(e,s){return appData.wormholes[e]||appData.wormholes[s]||this.dummyWormholes[e]||this.dummyWormholes[s]||void 0},this.likelyWormhole=function(e,s){const o=systemAnalysis.analyse(e).class,n=systemAnalysis.analyse(s).class;return this.dummyWormholes[String(o+"/"+n).indexOf("13")>=0?"SML":1==o||1==n?"MED":o>=5&&n>=5?"XLG":"LRG"]}};
