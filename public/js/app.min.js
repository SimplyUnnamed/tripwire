...
var chain=new function(){var i=this;this.map,this.view,this.drawing,this.data={},thirdPartySuppliers=[thera];const e={orgChart:new ChainMapRendererOrgchart(this),radial:new ChainMapRendererRadial(this)};this.renderer=e[options.chain.renderer],this.renderer.switchTo(),this.useRenderer=function(i){if(!e[i])throw"Unknown renderer "+i;this.renderer!=e[i]&&(this.renderer.switchFrom(),this.renderer=e[i],this.renderer.switchTo(),this.redraw())},this.activity=function(i){for(var e=0,s=(t=document.querySelectorAll("#chainMap .nodeActivity span")).length;e<s;++e)t[e].className=t[e].className+" invisible";var t;for(e=0,s=(t=document.querySelectorAll("#chainMap [data-nodeid]")).length;e<s;++e){var a=t[e].getAttribute("data-nodeid");if(i[a]){var n=i[a].shipJumps,r=i[a].podKills,l=i[a].shipKills,c=i[a].npcKills,o=t[e].getElementsByClassName("nodeActivity")[0];if(n>0){var d=o.getElementsByClassName("jumps")[0];d.className=d.className.replace(/invisible/g,""),d.setAttribute("data-tooltip",n+" Jumps")}if(r>0){var h=o.getElementsByClassName("pods")[0];h.className=h.className.replace(/invisible/g,""),h.setAttribute("data-tooltip",r+" Pod Kills")}if(l>0){var p=o.getElementsByClassName("ships")[0];p.className=p.className.replace(/invisible/g,""),p.setAttribute("data-tooltip",l+" Ship Kills")}if(c>0){var m=o.getElementsByClassName("npcs")[0];m.className=m.className.replace(/invisible/g,""),m.setAttribute("data-tooltip",c+" NPC Kills")}}}return SystemActivityToolTips.attachedElements&&SystemActivityToolTips.attachedElements.length>0&&SystemActivityToolTips.detach($("#chainMap .whEffect")),SystemActivityToolTips.attach($("#chainMap .nodeActivity > span[data-tooltip]:not(.invisible)")),i},this.occupied=function(i){for(var e in $("#chainMap [data-icon='user'], #chainMap [data-icon='user'] + .badge").addClass("invisible"),i)$("#chainMap [data-nodeid='"+i[e].systemID+"'] [data-icon='user']").removeClass("invisible"),$("#chainMap [data-nodeid='"+i[e].systemID+"'] [data-icon='user'] + .badge").removeClass("invisible").html(i[e].count);return OccupiedToolTips.attach($("#chainMap [data-icon='user']:not(.invisible)")),i},this.flares=function(i){if($("#chainMap div.node").removeClass("redNode yellowNode greenNode"),$("#chainGrid tr").removeClass("red yellow green"),i)for(var e in i.flares){var s=i.flares[e].systemID,t=i.flares[e].flare,a=($("#chainMap [data-nodeid="+s+"]").addClass(t+"Node").parent().index()-1)/3*2;a>0&&$("#chainGrid tr:eq("+a+")").addClass(t).next().addClass(t)}return i},this.grid=function(){if(0==options.chain.gridlines)return $("#chainGrid tr").addClass("hidden"),!1;$("#chainGrid tr").removeClass("hidden");var i=Math.max(0,2*$(".google-visualization-orgchart-table tr:has(.node)").length-1);$("#chainGrid tr:gt("+i+")").addClass("hidden")},this.nodes=function(i){var e={cols:[{label:"System",type:"string"},{label:"Parent",type:"string"}],rows:[]},s=["Q003","E004","L005","Z006","M001","C008","G008","A009","SML"],t=[];function a(i,e){if(!i||!tripwire.systems[i])return!1;const s=options.chain.tabs[options.chain.active];return n(i,e,null,null,s&&0!=s.systemID&&0>s.systemID.indexOf(",")?options.chain.tabs[options.chain.active].name:void 0,"&nbsp;",["top-level"])}function n(i,e,s,t,a,n,r){var l=function(i){var e=systemAnalysis.analyse(i);if(!e){var s="string"==typeof i&&i.indexOf("|")>=0?tripwire.aSigSystems[i.substring(0,i.indexOf("|"))]:null;const t=s&&"Class-"==s.substring(0,6)?1*s.substring(6):void 0,a="High-Sec"==s?.8:"Low-Sec"==s?.4:"Null-Sec"==s?-.1:void 0,n="Triglavian"==s?500026:void 0;e=systemAnalysis.analyse(i,{security:a,class:t,factionID:n})}return"<span class='"+e.systemTypeClass+"'>"+e.systemTypeName+e.systemTypeModifiers.join("")+"</span>"}(i);const c=tripwire.systems[i];var o=null,d=null;if(c&&c.effect){switch(c.effect){case"Black Hole":o="blackhole";break;case"Cataclysmic Variable":o="cataclysmic-variable";break;case"Magnetar":o="magnetar";break;case"Pulsar":o="pulsar";break;case"Red Giant":o="red-giant";break;case"Wolf-Rayet Star":o="wolf-rayet"}d=c.effect}a=_.escape(a);const h="name"==options.chain.sigNameLocation?a||(c?c.name:"&nbsp;"):"name_prefix"==options.chain.sigNameLocation&&a?a+(c?" - "+c.name:""):c?c.name:"&nbsp;";var p={v:e,systemID:i},m="<div id='node"+e+"' data-nodeid='"+i+"'"+(s?" data-sigid='"+s+"'":"")+(t?" data-inSigid='"+t+"'":"")+" class='node "+(r||[]).join(" ")+"'><div class='nodeIcons'><div style='float: left;'><i class='whEffect' "+(o?"data-icon='"+o+"' data-tooltip='"+d+"'":null)+"></i></div><div style='float: right;'><i data-icon='user' class='invisible'></i><span class='badge invisible'></span></div></div><h4 class='nodeClass'>"+l+"</h4><h4 class='nodeSystem'>"+(c?"<a href='.?system="+c.name+"'>"+h+"</a>":h)+"</h4><h4 class='nodeType'>"+n+"</h4><div class='statics'>"+function(i){if(!i)return"";const e={"High-Sec":"H","Low-Sec":"L","Null-Sec":"N",Triglavian:"▼","Class 1":"1","Class 2":"2","Class 3":"3","Class 4":"4","Class 5":5,"Class 6":6},s={H:"hisec",L:"lowsec",N:"nullsec","▼":"triglavian"};return i.map(function(i){const t=e[tripwire.wormholes[i].leadsTo];return'<span class="'+(s[t]||"class-"+t)+'" data-tooltip="'+tripwire.wormholes[i].leadsTo+" via "+i+'">'+t+"</span>"}).join("")}(c?c.statics:[])+"</div><div class='nodeActivity'><span class='jumps invisible'>&#9679;</span>&nbsp;<span class='pods invisible'>&#9679;</span>&nbsp;&nbsp;<span class='ships invisible'>&#9679;</span>&nbsp;<span class='npcs invisible'>&#9679;</span></div></div>";return p.f=m,p}function r(i,e,s){var t=guidance.findShortestPath(tripwire.map.shortest,[s-3e7,e.child.systemID-3e7]);if(!t)return null;var a={calculated:!0,life:"Gate",parent:{}};return a.parent.id=e.child.id,a.parent.systemID=e.child.systemID,a.parent.name=e.child.name,a.parent.type=e.child.type,a.parent.nth=e.child.nth,a.child={},a.child.id=++i,a.child.systemID=s,a.child.name=tripwire.systems[s].name,a.child.path=t,a.child.jumps=t.length-1,a.child.nth=null,{childID:i,calcNode:a}}function l(i){if(i[0]<=0)return!1;var e=parseInt(i[1]),s=o.length;const t=[],a=function(i){$("#show-viewing").hasClass("active")&&tripwire.systems[i.child.systemID]&&!tripwire.systems[viewingSystemID].class&&!tripwire.systems[i.child.systemID].class&&viewingSystemID!=i.child.systemID&&((t=r(s,i,viewingSystemID))&&(s=t.childID,h.push(t.calcNode),o.push([0,s])));if($("#show-favorite").hasClass("active")&&tripwire.systems[i.child.systemID]&&!tripwire.systems[i.child.systemID].class)for(var e in options.favorites){var t;if(!(tripwire.systems[options.favorites[e]].regionID>=11e6||tripwire.systems[i.child.systemID].regionID>=11e6||options.favorites[e]==i.child.systemID))(t=r(s,i,options.favorites[e]))&&(s=t.childID,h.push(t.calcNode),o.push([0,s]))}};for(var n in d){var l=d[n];if(-1==$.inArray(l.id,p)){var c,m,y,u,v,f,g;if("secondary"==l.parent?(c=tripwire.client.signatures[l.secondaryID],m=tripwire.client.signatures[l.initialID]):(c=tripwire.client.signatures[l.initialID],m=tripwire.client.signatures[l.secondaryID]),y=l.type,"K162",c&&c.systemID==i[0])u=c,v=m,f="K162",g=y;else{if(!m||m.systemID!=i[0])continue;u=m,v=c,g="K162",f=y}var w={};w.id=l.id,w.life=l.life,w.mass=l.mass,w.time=u.modifiedTime,w.parent={},w.parent.id=e,w.parent.systemID=tripwire.systems[u.systemID]?u.systemID:u.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),w.parent.name=u.name,w.parent.type=f,w.parent.typeBM=null,w.parent.classBM=null,w.parent.nth=null,w.parent.signatureID=v.signatureID,w.parent.sigIndex=v.id,w.child={},w.child.id=++s,w.child.systemID=tripwire.systems[v.systemID]?v.systemID:v.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),w.child.name=v.name,w.child.type=g,w.child.typeBM=null,w.child.classBM=null,w.child.nth=null,w.child.signatureID=u.signatureID,w.child.sigIndex=u.id,h.push(w),o.push([w.child.systemID,w.child.id,i[2]]),p.push(w.id),tripwire.systems[v.systemID]&&t.push(1*v.systemID),a(w)}}thirdPartySuppliers.forEach(function(n){const r={parentID:e,nextChildID:++s},l=n.findLinks(1*i[0],r);if(l){s=r.nextChildID-1;for(var c=0;c<l.length;c++){var d=l[c];0>p.indexOf(d.id)&&(0>t.indexOf(d.child.systemID)&&(d.thirdParty=n.nodeNameSuffix,h.push(d),o.push([d.child.systemID,d.child.id,i[2]]),t.push(d.child.systemID),a(d)),p.push(d.id))}}})}if($("#chainTabs .current").length>0){var c=$("#chainTabs .current .name").data("tab").toString().split(","),o=[],d=i,h=[],p=[];if(0==c){let s=0;Object.keys(i).slice().forEach(t=>{const n=tripwire.client.signatures[i[t].initialID],r=tripwire.client.signatures[i[t].secondaryID];n&&tripwire.systems[n.systemID]&&void 0===tripwire.systems[n.systemID].class?(s++,e.rows.push({c:[a(n.systemID,s),{v:null}]}),o.push([n.systemID,s,n.systemID])):r&&tripwire.systems[r.systemID]&&void 0===tripwire.systems[r.systemID].class&&(s++,e.rows.push({c:[a(r.systemID,s),{v:null}]}),o.push([r.systemID,s,r.systemID]))})}else for(var m in c)e.rows.push({c:[a(c[m],parseInt(m)+1),{v:null}]}),o.push([c[m],parseInt(m)+1,c[m]]);for(var y=0;y<o.length;y++)l(o[y])}else{$("#chainError").hide();var u={c:[]},v=viewingSystemID;u.c.push(a(v,1),{v:null}),e.rows.push(u);for(o=[[v,1]],d=i,h=[],p=[],y=0;y<o.length;++y)l(o[y])}const f={};for(var m in h){var g=h[m];u={c:[]};const i="id"==options.chain["node-reference"]?g.child.signatureID?g.child.signatureID.substring(0,3):"???":(g.child.type||"(?)")+sigFormat(g.child.typeBM,"type"),a=g.child.path?this.renderPath(g.child.path):"<a href='#' onclick='openSignatureDialog({data: { signature: "+g.child.sigIndex+', mode: "update" }}); return false;\'>'+_.escape(g.parent.name&&"ref"==options.chain.sigNameLocation?g.parent.name:g.parent.name&&"ref_prefix"==options.chain.sigNameLocation?g.parent.name+" - "+i:i)+"</a>",r=g.calculated?["calc"]:f[g.child.systemID]?["loop"]:[];g.thirdParty&&r.push("third-party","third-party-"+g.thirdParty);var w=[];"critical"==g.life&&w.push("eol"),"critical"==g.mass?w.push("critical"):"destab"==g.mass&&w.push("destab"),-1==$.inArray(g.parent.type,s)&&-1==$.inArray(g.child.type,s)||w.push("frig");const l=(f[g.parent.systemID]||{chainModifiers:[]}).chainModifiers;u.chainModifiers=w.concat(l),u.chainModifiers.forEach(function(i){w.push(i+"-chain")});const c=n(g.child.systemID,g.child.id,g.id,g.child.sigIndex,g.parent.name,a,r.concat(w));var I={v:g.parent.id};u.c.push(c,I),e.rows.push(u),w.length&&t.push(Array(c.v,I.v,w,g.id)),g.calculated||(f[g.child.systemID]=u)}return t.reverse(),{map:e,lines:t}},this.renderPath=function(i){if(i.length<=1||i.length>options.chain.routingLimit)return""+i.length-1;for(var e=i.slice(0,i.length-1).reverse().map(function(i){const e=3e7+1*i,s=systemAnalysis.analyse(e);return'<span class="'+s.systemTypeClass+'" data-tooltip="'+s.name+" ("+s.security+')" onclick="tripwire.systemChange('+e+')">'+s.pathSymbol+"</span>"}),s='<span class="path">',t=0;t<e.length;t++)t>0&&0==t%5&&(s+="|"),s+=e[t];return s+"</span>"},this.setActiveTab=function(e){$("#chainTabs .tab").removeClass("current"),options.chain.active=e,null!=e&&$("#chainTabs .tab").eq(e).addClass("current"),options.save(),i.redraw(),tripwire.parse(tripwire.client,"refresh")},this.redraw=function(){this.useRenderer(options.chain.renderer);var i=$.extend(!0,{},this.data);i.map=$.extend(!0,{},i.rawMap),this.draw(i)};var s=null;this.draw=function(e){e=void 0!==e?e:{};if(clearTimeout(s),!this.renderer.ready()||Object.size(e.map)&&!tripwire.client.signatures)s=setTimeout(function(){i.draw(e)},100);else{if(e.map){this.drawing=!0,this.data.rawMap=$.extend(!0,{},e.map),Object.sort(e.map,"id"),$.extend(e,this.nodes(e.map)),$.extend(this.data,e);const i=options.chain.tabs[options.chain.active]&&options.chain.tabs[options.chain.active].collapsed||[];this.renderer.draw(e.map,e.lines,i),this.grid(),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),WormholeRouteToolTips.attach($("#chainMap .path span[data-tooltip]")),SystemActivityToolTips.attach($("#chainMap .nodeClass span[data-tooltip]")),this.drawing=!1}!this.data.activity||new Date>this.data.activity.expires?(e.activity={},tripwire.esi.universeJumps().done(function(i,s,t){e.activity.expires=new Date(t.getResponseHeader("expires")),$.each(i,function(s){e.activity[i[s].system_id]={systemID:i[s].system_id,shipJumps:i[s].ship_jumps}})}).then(function(){return tripwire.esi.universeKills().done(function(i){$.each(i,function(s){e.activity[i[s].system_id]?(e.activity[i[s].system_id].podKills=i[s].pod_kills,e.activity[i[s].system_id].shipKills=i[s].ship_kills,e.activity[i[s].system_id].npcKills=i[s].npc_kills):e.activity[i[s].system_id]={systemID:i[s].system_id,podKills:i[s].pod_kills,shipKills:i[s].ship_kills,npcKills:i[s].npc_kills}})})}).then(function(){i.data.activity=i.activity(e.activity)})):e.map&&i.activity(this.data.activity),e.occupied&&(this.data.occupied=this.occupied(e.occupied)),e.flares&&(this.data.flares=this.flares(e.flares))}},this.updateCollapsed=function(e){options.chain.tabs[options.chain.active]&&(options.chain.tabs[options.chain.active].collapsed=e),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),i.activity(i.data.activity),i.occupied(i.data.occupied),i.flares(i.data.flares),i.grid(),options.save()}};
