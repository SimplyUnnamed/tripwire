...
tripwire.comments=function(){this.comments.data={},this.comments.parse=function(t){function e(t){const e=["b","i","em","strong","font","s","pre","span","p","br","h1","h2","h3","h4","h5","h6"];return t.replaceAll(/<\s*(\/?)\s*(\w+)([^>]*)>/g,(t,m,i,o)=>e.indexOf(i)>=0?t:"").replaceAll(/(on\w+)=/g,"x_$1=")}for(var m in t){var i=t[m].id;if(Object.find(tripwire.comments.data,"id",i)||0!=$(".comment[data-id='"+i+"']").length){if(Object.find(tripwire.comments.data,"id",i)&&Object.find(tripwire.comments.data,"id",i).modified!=t[m].modified){o=$(".comment[data-id='"+i+"']");try{o.find(".commentBody").html(e(t[m].comment))}catch(t){o.find(".commentFooter").show(),o.find(".commentStatus").html("<span class='critical'>"+t.constructor.name+": "+t.message+"</span>"),o.find(".commentFooter .commentControls").hide()}o.find(".commentModified").text("Edited by "+t[m].modifiedByName+" at "+t[m].modified),o.find(".commentSticky").addClass(t[m].sticky?"active":"")}}else{var o=$(".comment:last").clone(),n=$(".comment:visible:last .commentBody").attr("id")?$(".comment:visible:last .commentBody").attr("id").replace("comment","")+1:0;$(".comment:last").before(o),o.attr("data-id",i);try{o.find(".commentBody").html(e(t[m].comment))}catch(t){o.find(".commentFooter").show(),o.find(".commentStatus").html("<span class='critical'>"+t.constructor.name+": "+t.message+"</span>"),o.find(".commentFooter .commentControls").hide()}o.find(".commentModified").text("Edited by "+t[m].modifiedByName+" at "+t[m].modified),o.find(".commentCreated").text("Posted by "+t[m].createdByName+" at "+t[m].created),o.find(".commentBody").attr("id","comment"+n),o.find(".commentSticky").addClass(t[m].sticky?"active":""),o.removeClass("hidden"),Tooltips.attach(o.find("[data-tooltip]"))}}for(var m in tripwire.comments.data){i=tripwire.comments.data[m].id;if(!Object.find(t,"id",i))(o=$(".comment[data-id='"+i+"']")).remove()}tripwire.comments.data=t}},tripwire.comments();
